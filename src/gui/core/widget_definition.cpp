...
resolution_definition::resolution_definition(const config& cfg)
	: window_width(cfg[str_window_width].to_unsigned())
	, window_height(cfg[str_window_height].to_unsigned())
	, min_width(cfg[str_min_width].to_unsigned())
	, min_height(cfg[str_min_height].to_unsigned())
	, default_width(cfg[str_default_width].to_unsigned())
	, default_height(cfg[str_default_height].to_unsigned())
	, max_width(cfg[str_max_width].to_unsigned())
	, max_height(cfg[str_max_height].to_unsigned())
	, linked_groups()
	, text_extra_width(cfg[str_text_extra_width].to_unsigned())
	, text_extra_height(cfg[str_text_extra_height].to_unsigned())
	, text_font_size(cfg[str_text_font_size])
	, text_font_family(font::decode_family_class(cfg[str_text_font_family]))
