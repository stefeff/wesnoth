...
wml_menu_item::wml_menu_item(const std::string& id, const config& cfg)
	...
	, show_if_(cfg.child_or_empty(str_show_if), true)
	, filter_location_(cfg.child_or_empty(str_filter_location), true)
	, command_(cfg.child_or_empty(str_command))
	, default_hotkey_(cfg.child_or_empty(str_default_hotkey))
