...
game_classification::game_classification(const config& cfg)
	...
	, end_text_duration(std::clamp(chrono::parse_duration(cfg[str_end_text_duration], 0ms), 0ms, 5000ms))
